...
var discussion = [
  ...
  {
    name: "Megan",
    text: "I'd love to visit India with you",
    delay: 3500,
    offsetDelay: 250,
    mode: "message",
  },
  ...
  {
    name: "Kumar@jeetcurry",
    text: "I hav papadom for dinner n rugged 2 projek",
    delay: 3500,
    offsetDelay: 250,
    mode: "message",
  },
